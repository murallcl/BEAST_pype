# Contributor Covenant Code of Conduct for the BEAST_pype project

([Français](#code-de-conduite-pour-le-projet-nom-du-projet))

Contributors to repositories hosted in BEAST_pype are expected to follow the Contributor Covenant Code of Conduct, and those working within Government are also expected to follow the Values and Ethics Code for the Public Sector
...
This Code of Conduct applies both within project spaces and in public spaces when an individual is representing the project, members or Public Health Agency of Canada.
Examples of representing a project, members or Public Health Agency of Canada include using an official project e-mail address, posting via an official social media account, or acting as an appointed representative at an online or offline event.
Representation of a project may be further defined and clarified by project maintainers.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting the project team at [Martin.Grunnill@phac-aspc.gc.ca](mailto:Martin.Grunnill@phac-aspc.gc.ca).
